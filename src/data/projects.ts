...
export const projects: Project[] = [
  ...
  },
  {
    ...
    github: 'https://github.com/TheFirstIstari/IHaveWatched',
    status: 'Active',
    featured: true,
  ...
  {
    id: 'netryx-astra',
    title: 'Netryx Astra V2',
    description: 'AI geolocation tool that estimates where an image was taken using modern visual matching and geospatial reasoning.',
    tags: ['Python', 'Computer Vision', 'MASt3R', 'Geolocation'],
    github: 'https://github.com/TheFirstIstari/Netryx-Astra-V2-Geolocation-Tool',
    status: 'Active',
    featured: true,
    detail: 'Combines image-based location inference with CVPR/ECCV-era visual matching research, including MegaLoc and MASt3R references. Built as a practical single-image geolocation workflow with demo assets and a community-oriented README.',
  },
  {
    id: 'traincraft',
    title: 'Traincraft',
